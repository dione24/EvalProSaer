 ...
 */
final class Version20240507231436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, statut_id INT DEFAULT NULL, user_id INT DEFAULT NULL, nom LONGTEXT NOT NULL, client VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, date_debut DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', date_fin DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', created_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_50159CA9F6203804 (statut_id), INDEX IDX_50159CA9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE statut (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, couleur VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
